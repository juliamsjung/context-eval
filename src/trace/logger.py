...
TRACE ONLY: This module handles all observability/debugging concerns.
The RunLogger writes structured events for analysis but none of this
data should flow into agent-visible context bundles.
"""
...
class RunLogger:
    """
    TRACE ONLY: Run-scoped logger that writes JSONL events for a single run.

    This logger is part of the observability/trace layer. All data written here
    is for debugging and analysis purposes. None of this data should be passed
    to agent-visible prompts or context bundles.
    ...
    def log_run_start(
        ...
        *,
        ...
        seed: int,
        notes: str = "",
        # TRACE ONLY: experiment_tags are for analysis only.
