...
└── DESIGN.md      # Design rationale and normalization scheme
```
...
See [experiments/metrics/DESIGN.md](experiments/metrics/DESIGN.md) for design rationale and normalization scheme details.
